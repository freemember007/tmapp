...
exports.publishText = function(content) {
    send("api/publish_blog", {
        content: content,
        id: Titanium.App.Properties.getString("userid")
    }, function(res) {
...
exports.uploadPhoto = function() {
    Ti.Media.openPhotoGallery({
        success: function(e) {
            mvc.view.publishPhoto.show(computeImageSize(e.media), !1);
        },
        error: function() {
            alert("error");
        }
...
exports.uploadCameraPhoto = function() {
    Ti.Media.showCamera({
        success: function(e) {
            Ti.Media.hideCamera();
            mvc.view.publishPhoto.show(computeImageSize(e.media), !0);
        },
        error: function() {
            alert("error");
        },
